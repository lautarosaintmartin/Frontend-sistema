            ...
            <form onsubmit={(e) => movementModel.createMovements(e)}>
                ...
                <div class="p-2 flex flex-col">
                    ...
                    {#if movementModel.messageError?.type}
                        <p class="text-red-600">{movementModel.messageError.type}</p>
                    {/if}
                </div>
                ...
                <div class="p-2 flex flex-col">
                    ...
                    {#if movementModel.messageError?.date}
                        <p class="text-red-600">{movementModel.messageError.date}</p>
                    {/if}
                </div>
                ...
                <div class="p-2 flex flex-col">
                    ...
                    {#if movementModel.messageError?.amount}
                        <p class="text-red-600">{movementModel.messageError.amount}</p>
                    {/if}
                </div>
                ...
                <div class="p-2 flex flex-col">
                    ...
                    {#if movementModel.messageError?.priceUnit}
                        <p class="text-red-600">{movementModel.messageError.priceUnit}</p>
                    {/if}
                </div>
